...
When generating files, plugins can specify import preferences to control how symbols are resolved. See [Symbol Resolution - Import Preferences](/pencel/internals/preprocessing/#import-preferences) for detailed examples.
