...
See [Plugin System](/pencel/internals/plugins/) for details on how plugins register and control symbols.
...
Plugins can control how symbols are imported in specific files using `ImportPreference`. See [Plugin System - File Creation with Preferences](/pencel/internals/plugins/#file-creation-with-preferences) for complete examples.
