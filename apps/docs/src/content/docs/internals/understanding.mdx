...
See [Architecture Overview](/pencel/internals/architecture/) for the 7-phase pipeline, [File Management](/pencel/internals/file-management/) for how imports are managed.
