...
description: "Component schema specification scope, conformance criteria, and versioning guidelines."
---


## 1. Scope

This specification defines the **Universal Component Schema**, a JSON-based format for declaring UI components in a platform-agnostic manner.
...
- **Platform mapping semantics** (how components compile to target platforms)
...
1. Accepts a conforming component schema
...
2. Maps schema states to platform-specific visual/interaction states
...
A component schema **MUST** declare its `schemaVersion` (e.g., `"1.0.0"`). Compilers MUST validate version compatibility before compilation.
